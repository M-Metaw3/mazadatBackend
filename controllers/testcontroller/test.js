...
//       }
//     }
//     const subcategoryResult = await SubcategoryResult.find({});
// res.status(200).json({ status: "success", subcategoryResult });
...
// }
  ...
  //           }
  //         },
  //         commission1: '$itemDetails.commission1',
  //         commission2: '$itemDetails.commission2',
  //         commission3: '$itemDetails.commission3',
  ...
  //                 { case: { $eq: ['$status', 'inprogress'] }, then: 'inprogress' },
  //                 { case: { $eq: ['$status', 'pending'] }, then: 'pending' },
  //                 { case: { $eq: ['$status', 'loser'] }, then: 'loser' }
  //               ],
  //               default: 'inprogress'
  //             }
  //           },
  ...
  //                   input: '$winnerDetails',
  //                   as: 'winner',
  //                   cond: { $eq: ['$$winner.itemId', '$itemDetails._id'] }
  //                 }
  //               },
  //               0
  //             ]
